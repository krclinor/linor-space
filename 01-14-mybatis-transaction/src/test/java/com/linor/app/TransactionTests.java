...
public class TransactionTests {
	...
	public void test21UpdateSinger() {
		log.info("테스트2-1시작--->>>");
		Singer1 singer1 = singer1Dao.findById(1);
		Singer2 singer2 = singer2Dao.findById(1);
		log.info(">>> 김종서 수정 전 >>>");
		...
		Singer1 newSinger1 = singer1Dao.findById(1);
		Singer2 newSinger2 = singer2Dao.findById(1);
		log.info(">>> 김종서 수정 후 >>>");
	...
	public void test32DeleteSinger() {
		log.info("테스트3-1시작--->>>");
		Singer1 singer1 = singer1Dao.findById(10);
		Singer2 singer2 = singer2Dao.findById(1);
		try {
			singerService.deleteScenario(singer1, singer2);
		}catch (Exception e) {
	...
	public void test33DeleteSinger() {
		log.info("테스트3-1시작--->>>");
		Singer1 singer1 = singer1Dao.findById(1);
		Singer2 singer2 = singer2Dao.findById(10);
		try {
			singerService.deleteScenario(singer1, singer2);
		}catch (Exception e) {
			log.error("에러 발생해야 함");
